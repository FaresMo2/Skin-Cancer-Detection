      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="relative flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div className="flex items-center gap-8">
            <a
              href="#contact"
              className=" text-white font-semibold rounded md:hover:text-blue-700"
            >
              Contact
            </a>
            <button
        ...
        <div
          ...
          id="navbar-user"
        >
          <ul className="text-white flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  ">
            <li>
              <NavLink
                to="/main"
                className="text-blue-500 block py-2 px-3 rounded md:bg-transparent md:p-0 md:hover:text-blue-700"
                aria-current="page"
              >
                Home
              </NavLink>
