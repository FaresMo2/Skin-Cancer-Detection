        ...
        >
          ...
          <div className="inline-flex items-center">
            ...
            <label className="text-gray-700 font-light select-none cursor-pointer mt-px">
              <p className="antialiased font-sans text-sm leading-normal text-gray-700 flex items-center justify-start font-medium">
                I agree the
                <Link className="ml-2 font-normal text-black transition-colors hover:text-gray-900 underline">
